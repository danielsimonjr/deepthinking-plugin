...
**v0.5.0 — All 34 reasoning modes shipped.** End-to-end smoke tested via headless `claude -p` against all modes; interactive HTML dashboard + 13 output formats supported. See [CHANGELOG.md](CHANGELOG.md) for the v0.1.0 → v0.5.0 progression.
