...
**Current version:** v0.5.1. GitHub: https://github.com/danielsimonjr/deepthinking-plugin.
...
- `CHANGELOG.md` — the v0.1.0 → v0.5.1 progression and what each release shipped
...
v0.5.1 is the current release; see the GitHub Releases page for the full history.
